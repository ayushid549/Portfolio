            ...
            <div className="home-page">
                <div className="about-profile">
                    <div className="greeting-section">
                     ...
                     <div className="btn">
                        <button><a className='resume' href='https://drive.google.com/file/d/1CFCgxyWbhJpEWYCNTQC3Jy0ZNEjq-uEb/view?usp=drivesdk' download='AYUSHI_DUBEY_Resume (1).pdf' target='_blank'>Resume</a></button>
                    </div>
